...
sub initPlugin {
  ...
  Foswiki::Func::registerTagHandler('TOPICTITLE', sub { return getCore()->TOPICTITLE(@_); });

  # alias
  Foswiki::Func::registerTagHandler('GETTOPICTITLE', sub { return getCore()->TOPICTITLE(@_); });
